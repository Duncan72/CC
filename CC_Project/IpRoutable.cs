...
{
    // Entire class copied from the user Richard R at:
    // https://stackoverflow.com/questions/8230728/is-there-a-function-that-can-take-an-ipaddress-as-string-and-tell-me-if-its-a-no
    class IpRoutable
    {
        /// <summary>
        /// 
        ...
        public static bool IsNonRoutableIpAddress(string ipAddress)
        {
            ...
            if (tempIpAddress.AddressFamily == System.Net.Sockets.AddressFamily.InterNetwork)
            {
                ...
                // Added by Michael Duncan
                else if (IsIpAddressInRange(ipAddressBytes, "224.0.0.0/4"))   //reserved for multicast messages
                {
                    return true;
                }
            ...
            else if (tempIpAddress.AddressFamily == System.Net.Sockets.AddressFamily.InterNetworkV6)
            {
                ...
                // Added by Michael Duncan
                else if (IsIpAddressInRange(ipAddressBytes, "ff00::/8"))   //reserved for multicast messages
                {
                    return true;
                }
